...
const Footer = () => {
  return (
    <div className="w-full bg-white dark:bg-[#0c0c0d04] rounded-lg p-4 grid md:grid-cols-12 gap-4 items-center justify-center mt-10">
      ...
      <nav className="md:col-span-8 flex items-center gap-4 justify-center">
       <Link to={'/'}>
         <p className="xl:py-1 xl:px-2 rounded-lg  transition-colors dark:text-white/80">
           Home
         </p>
       </Link >
        ...
        <Link
          to={'/random'}
          className="xl:py-1 xl:px-2 rounded-lg  transition-colors dark:text-white/80"
        >
          Random
        </Link>
        {/* <a
